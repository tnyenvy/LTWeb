            ...
            <div class="content-form-page">
              ...
              <c:if test="${alert != null}">
                ...
                <div class="col-md-7 col-sm-7">
                  <form action="/Week2/login" method="post" class="form-horizontal form-without-legend" role="form">
                    ...
                    <div class="container" style="background-color: #f1f1f1">
                        ...
                        <span class="password"> <a href="/Week2/forget"> Forgot password?</a></span>
                        <!--  
                        <div class="container" style="background-color: #f1f1f1">
						<button type="button" class="cancelbtn">Cancel</button>
						<span class="psw"> <a href="/Week2/forget"> Forgot password?</a></span>
						</div>
						-->
                      </div>
                    </div>
